...
describe UsersController do
  ...
  end # End of describe "authentication  of edit/update pages"
  ...
  describe "DELETE 'destroy' " do
    ...
    end # End of describe "as a non-admin user"
    ...
    end # End fo describe "as an admin user" 
  ...
  end #End of   describe "follow pages"
end
